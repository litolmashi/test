<?php
    ...
    // if(isset($_POST["submit"])){
        $insertOneResult = $collection->insertOne([
            ...
            'function' => 'DELETE',
            'lastActionDone' => 'Cancel/Rejected order by seller',
    ...
    // if(isset($_POST["submit"])){
        ...
        if(mysqli_query($conn,$query) == TRUE){
            header('Location: ../blockchain/seller/Orders/RejectPage.php?result=1');
        }else{
            header('Location: ../blockchain/seller/Orders/RejectPage.php?result=2');
        }
    // }else{
