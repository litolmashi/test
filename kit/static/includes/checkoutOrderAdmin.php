<?php
    ...
    // if(isset($_POST["submit"])){
        $insertOneResult = $collection->insertOne([
            ...
            'function' => 'CREATE',
            'lastActionDone' => 'Shipped order by seller',
    ...
    // if(isset($_POST["submit"])){
        ...
        if(mysqli_query($conn,$query) == TRUE){
            header('Location: ../blockchain/seller/Orders/OrderListPage.php?result=1');
        }else{
            header('Location: ../blockchain/seller/Orders/OrderListPage.php?result=2');
        }
    // }else{
    //     header('Location: ../blockchain/seller/Orders/OrderListPage.php?result=3');
    // }
?>
